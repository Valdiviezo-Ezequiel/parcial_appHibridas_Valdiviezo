...
const juezNombre_required = 'El nombre del juez es un campo obligario.'

const juegoId_required = 'El ID del juego es obligario.'
const juegoNombre_required = 'El nombre del juego es un campo obligario.'
...
const votoSchema = yup.object({
  ...
  nombre_juez: yup.string().required(juezNombre_required) ,
  nombre_juego: yup.string().required(juegoNombre_required) ,
